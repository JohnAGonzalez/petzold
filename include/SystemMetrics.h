...
sysmetrics[] =
{
	...
	SM_CYVSCROLL,			TEXT("SM_CYVSCROLL"),			TEXT("Vertical scroll height"),
	SM_CXHSCROLL,			TEXT("SM_CXHSCROLL"),			TEXT("Horizontal scroll width"),
	...
	SM_SECURE,				TEXT("SM_SECURE"),				TEXT("Seurity present flag"),
	...
	SM_ARRANGE,				TEXT("SM_ARRANGE"),				TEXT("How minimized windows are arranged"),
